...
/**
 * Created by samdroid on 29/6/17.
 */

public class LinearLayoutThatDetectsSoftKeyboard implements ViewTreeObserver.OnGlobalLayoutListener{
    ...
    public LinearLayoutThatDetectsSoftKeyboard(View adjustableView) {
