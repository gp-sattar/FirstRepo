package com.grampower.fieldforce.Adapters;
...
import com.grampower.fieldforce.Activities.CalenderDatePicker;
...
public class TaskOperationsAdapter extends ExpandableRecyclerViewAdapter<TaskOperationsAdapter.MainTaskViewHolder, TaskOperationsAdapter.ChildTaskViewHolder> {
    ...
    public void onBindGroupViewHolder(MainTaskViewHolder holder, int flatPosition, ExpandableGroup group) {
        TaskOperationWrapper taskOperationWrapper;
        if(flatPosition<taskGroups.size()){
            //taskOperationWrapper=taskGroups.get(flatPosition);
            taskOperationWrapper=(TaskOperationWrapper)group;
